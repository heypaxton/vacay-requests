...
RSpec.describe Request, type: :model do
  before do
    ...
    @request = Request.create(status: 'pening', vacation_start_date: Date.tomorrow, vacation_end_date: Date.tomorrow + 5.days, author: "#{user.first_name}  #{user.last_name}", user_id: user.id)
  end
